...
# Non injection bump
        ...
        if s['Dispersion_Mismatch']:
                ...
                print '\t Original D_x_Lattice =', Lattice.etax0, ' m'
                print '\t Original  D_xp_Lattice =', Lattice.etapx0, ''
                twiss_dict['D_x'] 	= Lattice.etax0 + 0.282 # Measured at SEM Grid BSG52H - taken as maximum
                twiss_dict['D_xp'] 	= Lattice.etapx0 + 0.103 # Measured at SEM Grid BSG52H - taken as maximum
